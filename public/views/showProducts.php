...
foreach ($data as $article) {
    ...
    echo '
        <div class="product-card">
            ...
            <form action="index.php" method="GET" style="margin-top: auto; width: 100%;" id="form_' . htmlspecialchars($article["ID_Producto"]) . '">
                <div class="actions">
                    <a href="index.php?controller=ProductsController&action=verDetallesProducto&idProducto=' . htmlspecialchars($article["ID_Producto"]) . '" class="view" title="Ver detalles">
                        <img style="width: 20px;" src="../utils/eye.svg"/>
                    </a>
                    
                    <a href="index.php?controller=ListaDeseosController&action=agregarProducto&producto_id=' . htmlspecialchars($article["ID_Producto"]) . '" class="wishlist" title="Añadir a lista de deseos">
    ...
    if (isset($_SESSION["rol"]) && $_SESSION["rol"] === "admin") {
        echo '
                    <a href="index.php?controller=ProductsController&action=eliminarProducto&id=' . htmlspecialchars($article["ID_Producto"]) . '" class="delete" title="Eliminar producto" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este producto?\');">
