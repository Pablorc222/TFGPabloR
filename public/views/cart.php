        ...
        <div style="width: 50%; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 20px; margin-bottom: 20px;">
           <!-- Productos en el carrito -->
            ...
            if (empty($data)) {
                ...
                echo '<a href="index.php?controller=ProductsController&action=getAllProducts" style="display: inline-block; margin-top: 15px; padding: 8px 15px; background-color: #437F97; color: white; text-decoration: none; border-radius: 5px;">Seguir comprando</a>';
                echo '</div>';
            } else {
                $total = 0;
                foreach ($data as $producto) {
                    ...
                    echo '</div>';
                    echo '<a href="index.php?controller=ProductsController&action=eliminarDelCarrito&id=' . $producto['ID_Producto'] . '" style="text-decoration: none; color: inherit; padding: 10px; background-color: #98D9C2; border: none; border-radius: 5px; cursor: pointer; width: 40px; height: 40px; display: flex; justify-content: center; align-items: center;">';
                ...
                echo '<a href="index.php?controller=ProductsController&action=getAllProducts" style="text-decoration: none;">';
                ...
                if (isset($_SESSION['usuario'])) {
                    ...
                    echo '<a href="index.php?controller=ValoracionesController&action=mostrarValoracionPostCompra" style="text-decoration: none;">';
                    ...
                    $_SESSION['redirect_after_login'] = "index.php?controller=ProductsController&action=confirmarPedido";
